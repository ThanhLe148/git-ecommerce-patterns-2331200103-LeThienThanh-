...
class CheckoutFacade {
    ...
    placeOrder(orderDetails) {
       ...
       if(!this.inventoryService.checkStock(orderDetails.productIds)) return;
       if(!this.paymentService.processPayment(orderDetails.userId, orderDetails.amount)) return;
